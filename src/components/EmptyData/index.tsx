...
export const NoData: React.FC<{ width?: number; height?: number }> = ({
  width = 647.636,
  height = 632.174,
}) => {
  return (
    <svg
      ...
      width={width}
      height={height}
      data-name='component-svg-no-data'
    ...
    >
      ...
      ></path>
      <circle cx='190.154' cy='24.955' r='20' fill='#00875f'></circle>
      <circle cx='190.154' cy='24.955' r='12.665' fill='#323238'></circle>
      <path
        fill='#323238'
      ...
      ></path>
      <circle cx='433.636' cy='105.174' r='20' fill='#00875f'></circle>
      <circle cx='433.636' cy='105.174' r='12.182' fill='#323238'></circle>
    </svg>
  )
}
